...
function Password({passwordName}: PasswordType) {
    const [passwordLength, setPasswordLength] = useState(0)
    const [formState, action ] = useFormState(generatePassword.bind(null, passwordLength ), { message: ""})
    ...
    return (
        <div className="flex flex-col gap-2  justify-center items-center mt-4 w-96 h-72 rounded-md p-4 bg-white">
            ...
            <p className="mt-8 p-4 w-[90%] h-16 text-3xl border shadow-md rounded-md">{passwordName}</p>
